...
[[life_barrier_activeObj, ["Block entfernen", "fn_placeablesRemoveAll", nil, 1, true, true, "", "if(playerside!=civilian) then {true} else {false};"]], "addAction", true, true] call BIS_fnc_MP;
sleep 0.5;
