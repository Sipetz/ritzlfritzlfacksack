...
class VirtualShops {
	...
	class market {
		...
		license = "";
		level[] = { "", "", -1, "" };
		items[] = { "waterBottle", "rabbit", "bottles", "cornmeal", "apple", "redgull", "tbacon", "pickaxe", "toolkit", "fuelFull", "peach", "storagesmall", "storagebig", "rabbit_raw", "hen_raw", "rooster_raw", "sheep_raw", "goat_raw" };
	};
